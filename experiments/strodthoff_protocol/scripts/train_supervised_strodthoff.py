#!/usr/bin/env python3
"""Train supervised baselines under Strodthoff-compatible PTB-XL protocol."""
...
def main() -> None:
    parser = argparse.ArgumentParser("Supervised Strodthoff-compatible training")
    ...
    result = run_training_pipeline(cfg, seed=seed, device=device, use_pretrained=False)
